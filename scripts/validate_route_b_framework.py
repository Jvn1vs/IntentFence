...
def validate() -> list[str]:
    ...
    for relative in (
        ...
        "src/intentfence/c2b_authorization.py",
        "src/intentfence/c2b_config.py",
        "scripts/validate_c2b_training_authorization.py",
        "scripts/validate_c2b_preflight.py",
        "scripts/validate_c2b_config.py",
