...
项目所有者已明确批准固定版本 Dolly-15k 的约 13.1 MB 下载、CC-BY-SA-3.0 归属保留，以及带参考文本的问答、摘要、信息抽取用途。下载已完成，原始 15011 条中筛选出 4467 条有参考文本的背景。独立 v3 已构造 20691 条（14582/2065/2044/2000），并保护 v2 calibration/Test A；独立 verifier 正在运行。详见 `reports/data/candidate_9_v3_build_20260909.md`。未训练就绪，不能据新增数据量声称模型收益。
